...
class LigerFishRig extends CharacterRig{
    constructor(){ super(); }
    ...
    _setupRig(){
        ...
        r.hindLegL  = r.add( arm, 'hindLegL', ['thigh_l', 'shin_l', 'meta_l', 'foot_l'] );
        r.hindLegR  = r.add( arm, 'hindLegR', ['thigh_r', 'shin_r', 'meta_r', 'foot_r'] );
        r.foreLegL  = r.add( arm, 'foreLegL', ['upperarm_l', 'forearm_l', 'hand_l'] );
        r.foreLegR  = r.add( arm, 'foreLegR', ['upperarm_r', 'forearm_r', 'hand_r'] );
